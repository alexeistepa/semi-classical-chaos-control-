...
subroutine test1_drf(n, np, t, r, Pr, f)
    implicit none
...
subroutine test1_dif(n, np, t,r,Pr,g)
    implicit none
...
! f2py -c -m fSRK_test1 fSRK0p42.f90
